...
METRICS_CSV="${METRICS_CSV:-${ROOT_DIR}/build/metrics/qwen3_30b_a3b_sft_pp8_l${LAYERS}_steps${STEPS}.csv}"
ID_PREFIX="${ID_PREFIX:-/tmp/cverl_qwen3_30b_a3b_sft_pp8}"
