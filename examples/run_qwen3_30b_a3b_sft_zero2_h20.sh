...
METRICS_CSV="${METRICS_CSV:-${ROOT_DIR}/build/metrics/qwen3_30b_a3b_${TRAIN_MODE}_zero2_dp${DP_SIZE}_tp${TP_SIZE}_ep${EP_SIZE}_seq$((PROMPT_LEN + RESPONSE_LEN))_steps${STEPS}.csv}"
ID_PREFIX="${ID_PREFIX:-/tmp/cverl_qwen3_30b_a3b_sft_zero2}"
...
common_env=(
  ...
  DP_SHARD_OPTIMIZER="${DP_SHARD_OPTIMIZER:-true}"
